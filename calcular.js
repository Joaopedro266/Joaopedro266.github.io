function calcular() {
   ...
   if(inputmedia > 28) {
      ...
      var mediazinha = inputvitorias / inputmedia;
         if (mediazinha < 0.5){
            resultadinho.innerText = "Voce é analfabeto, anta, azêmola, bronco, cavalgadura, estulto, estúpido, idiota, ignorante, imbecil, inepto, lerdaço, néscio, palerma, parvo, tapado, teimoso, tolo, toupeira, armação de serrador";
         }
         else {
